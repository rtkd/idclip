...
readLine.on('close', function()
{
	...
	if (buildHTML === true)
	{
		var
			html = [],
			files = [],
			htmlHead  = '<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{box-sizing:border-box;}nav a{display:inline-block;padding:1rem;}.item{display:inline-block;}.itemURL{margin-bottom:1rem;}</style></head><body>',
			htmlFoot = '</body></html>'
		;
